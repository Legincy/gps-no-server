...
func CreateStation(c *gin.Context){
	c.JSON(200, gin.H{"message": "Station erstellt"})
}
...
func GetStations(c *gin.Context){
	c.JSON(200, gin.H{"message": "Stationen zurückgegeben"})
}
...
func GetStation(c *gin.Context){
	mac := c.Param("mac")
	c.JSON(200, gin.H{"message": "Station zurrückgegeben", "mac": mac})
}
...
func UpdateStation(c *gin.Context){
	mac := c.Param("mac")
	c.JSON(200, gin.H{"message": "Station geupdated", "mac": mac})
}
...
func DeleteStation(c *gin.Context){
	mac := c.Param("mac")
	c.JSON(200, gin.H{"message": "Station gelöscht", "mac": mac})
}
...
func CreateCluster(c *gin.Context){
	c.JSON(200, gin.H{"message": "Cluster erstellt"})
}
...
func GetCluster(c *gin.Context){
	id := c.Param("id")
	c.JSON(200, gin.H{"message": "Cluster wiedergegeben", "id": id})
}
...
func GetClusters(c *gin.Context){
	c.JSON(200, gin.H{"message": "Cluster wiedergegeben"})
}
...
func UpdateCluster(c *gin.Context){
	id := c.Param("id")
	c.JSON(200, gin.H{"message": "Cluster geupdated", "id": id})
}
...
func DeleteCluster(c *gin.Context){
	id := c.Param("id")
	c.JSON(200, gin.H{"message": "Cluster gelöscht", "id": id})
}
